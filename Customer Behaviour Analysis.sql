...
-- How many films have a ratin R and a replacement cost of between $5 and $15?
...
-- A huge client wants to get the list of all the movies of Nick Walhberg?
...
-- We want to know and compare vrious amount of films we have per movie rate.
